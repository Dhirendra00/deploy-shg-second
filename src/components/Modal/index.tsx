    ...
    <Transition appear show={isOpen} as={Fragment}>
      ...
      >
        ...
        <div className="min-h-screen md:px-16 text-center">
          ...
          >
            <div
              className={`trans inline-block w-full max-w-3xl px-10 py-10 sm:px-8 space-y-8 overflow-hidden sidebar text-left align-middle transition-all transform bg-white shadow-E600 rounded-2xl`}
            >
              {children}
            </div>
          </Transition.Child>
