...
const Dashboard = () => {
  return (
    <MainLayout>
      <div className="flex justify-around sm:grid sm:grid-rows-6 ">
        <div className="shadow-E500 bg-white rounded-sm p-4 grid grid-rows-3 grid-flow-col gap-4 sm:my-4">
